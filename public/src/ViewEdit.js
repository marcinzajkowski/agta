...
AGTA.ViewEdit = Parse.View.extend
({
	el: "#ViewEdit",
	events:
	{
	...
	initialize: function( )
	{
		Logger.log( "AGTA.ViewEdit.initialize" );
		...
		AGTA.modelDispatcher.on( AGTA.modelDispatcher.EDIT_MEETING_SET, this.meeting, this );
	},
	focused: function( e )
	{
	...
	cancel: function( e )
	{
		...
		Logger.log( "AGTA.ViewEdit.cancel" );
	},
	submit: function( e )
	{
		e.preventDefault( );
		...
		Logger.log( "AGTA.ViewEdit.submit", e, isValid );
	},
	sendFormData: function( )
	{
		var formData = $( this.el ).find( "form" ).serializeArray( );
		
		Logger.log( "AGTA.ViewEdit.sendFormData", $( this.el ).find( "form" ), formData );
	...
	render: function( )
	{
		Logger.log( "AGTA.ViewEdit.render" );
		
		this.template = _.template( $("#TemplateViewEdit").html( ), AGTA.postData );
